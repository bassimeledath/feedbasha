...
.fb-slist{flex:1;overflow:auto;padding:12px 14px;display:flex;flex-direction:column;gap:10px}
.fb-tx{font-size:12px;color:#475569;line-height:1.7;background:#f6f8fa;border:1px solid #e5e8ee;border-radius:10px;padding:10px 12px}
.fb-tx .mk{color:var(--accent);font-weight:700}
.fb-empty{color:#94a3b8;font-size:12.5px;padding:2px}
.fb-item{border:1px solid #e5e8ee;border-radius:12px;padding:11px 12px;position:relative}
.fb-item .top{display:flex;align-items:center;gap:8px;margin-bottom:4px}
...
.fb-src{font-family:ui-monospace,Menlo,monospace;font-size:11.5px;color:#065f46;background:#effaf4;border-radius:6px;padding:2px 6px;display:inline-block;margin-top:2px;word-break:break-all}
.fb-said{font-size:13px;color:#334155;line-height:1.5;margin-top:6px}
.fb-said b{color:#94a3b8;font-weight:600}
.fb-del{position:absolute;top:9px;right:9px;border:0;background:transparent;color:#94a3b8;cursor:pointer;font-size:14px;line-height:1;padding:2px}
.fb-del:hover{color:#ef4444}
.fb-sfoot{padding:14px;border-top:1px solid #e5e8ee;display:flex;flex-direction:column;gap:8px}
